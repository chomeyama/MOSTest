...
2. Rewrite mos.js depending on the structure of the wav directory. You only need to customize the part from line 61.
...
You can utilize [ABXTest](https://github.com/chomeyama/ABXTest) if you want to conduct MOS test.
